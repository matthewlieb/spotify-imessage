...
3. Sign in with Spotify when the app opens.
4. For **Scan Messages**, grant **Full Disk Access**: **System Settings → Privacy & Security → Full Disk Access** → add SpotifiMessage. Install `imessage-exporter` if needed: `brew install imessage-exporter`.
